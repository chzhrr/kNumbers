namespace Numbers
{
    ...
    public class PawnColumnWorker_Race : Numbers_PawnColumnWorker_Text
    {
        ...
        {
            string text = pawn.kindDef.race.LabelCap.RawText ?? string.Empty;
        ...
        public override int Compare(Pawn a, Pawn b) => a.kindDef.race.LabelCap.RawText.CompareTo(b.kindDef.race.LabelCap.RawText);
    }
}
